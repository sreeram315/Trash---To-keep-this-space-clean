...
sbit rs=P0^2; //Register Select(RS) pin of 16*2 lcd
sbit rw=P0^1; //Read/Write(RW) pin of 16*2 lcd
sbit en=P0^0; //Enable(E) pin of 16*2 lcd
 
sbit rd_adc=P0^4; //Read(RD) pin of ADC0804
sbit wr_adc=P0^5; //Write(WR) pin of ADC0804
sbit intr_adc=P0^6; //Interrupt(INTR) pin of ADC0804
...
void main(void) //main function
{
  ...
  delay(100);  //interval between every cycles
