...
sbit ER=P0^4; sbit EY=P0^5; sbit EG=P0^6; sbit EGL=P0^7;   //Setting Bit for LED's South
sbit WER=P1^0; sbit WEY=P1^1; sbit WEG=P1^2; sbit WEGL=P1^3;  //Setting Bit for LED's East
sbit SR=P1^4; sbit SY=P1^5; sbit SG=P1^6; sbit SGL=P1^7; //Setting Bit for LED's West
unsigned char a[10]={0x90,0x80,0xF8,0x82,0x92,0x99,0xB0,0xA4,0xF9,0xC0}; //Array for displaying digits on segment 1,2.......9,0
unsigned char b[7]={0xA4,0xF9}; //Array for displaying 0 to 6
