...
#include<string.h>
	...
	unsigned char snames[][20]={"SREERAM MARAM","BEERA BHAI","GURU KANTH DESAI"};
	unsigned int srolls[]={47,48,45,41,25,54};
	unsigned int spins[]={2770,5894,5748,5135,4587};
	unsigned char ch,k=0,r=0,y=0;
	int a,b;
	unsigned int epin=0;
	unsigned int pres[];
