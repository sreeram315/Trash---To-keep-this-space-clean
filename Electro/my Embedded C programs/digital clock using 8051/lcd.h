...
void lcd_enable();
void lcd_cmd(unsigned char cmd); 				// To give a cmd to lcd
void lcd_data(unsigned char ascii);			// To display a character 
void lcd_string(unsigned char *lcd_string);	//Function to display a string on lcd
void lcd_gotoxy(unsigned char row,unsigned char column); //move cursor to the specified position
void lcd_stringXY(unsigned char row, unsigned char col, unsigned char *lcd_string); //Function to display string in particular position
void lcd_string(unsigned char *str);	//To display string
void lcd_numberxy(unsigned char row, unsigned char col,int val,unsigned int field_length); //Function to display nimber in particular position
